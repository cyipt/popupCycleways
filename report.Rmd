...
- We requested data from Highways England to flag the recommendations on the Strategic Road Network (SRN) and trialed adding a column to the results. Having tested the results we decided to add a column showing current speed limits on road sections instead, highlighting safety issues around potential routes and encouraging consideration speed limit reductions along strategic corridors with high cycling potential.
