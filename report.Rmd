...
Roads that met the spare space criteria but which were not selected as top routes were kept and can be shown in the layers named 'spare lane' and 'estimated width >10m', which are hidden by default to simplify the visualisation of results and to focus attention on the most important results, including the Cohesive network.


## Identification of a cohesive network
