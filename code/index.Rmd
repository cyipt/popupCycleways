...
The [Rapid Cycleway Prioritisation Tool](https://www.cyipt.bike/rapid/) is a research project and web application supported by the [Department for Transport](https://www.gov.uk/government/organisations/department-for-transport) and [Sustrans](https://www.sustrans.org.uk/) to help identify promising locations for road space reallocation in England.
...
m_regions = tm_shape(Regions) + tm_polygons("Level", popup.vars = FALSE, alpha = 0.3) +
...
Thanks also to all the contributors to OpenStreetMap who provided open data on which much of the analysis was based, allowing use to publish the results as open data under the conditions of the Open Data Commons Open Database License. Data (c) [OpenStreetMap](https://www.openstreetmap.org) contributors, ODbL 1.0. https://www.openstreetmap.org/copyright .
