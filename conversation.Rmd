...
These interventions can be classified into three broad groups, as outlined in a [paper](add link) that we have written outlining methods for prioritising pop-up active transport infrastructure.

First...

An example of the first type of intervention is illustrated in the image below, from Salford, Manchester

[![](https://pbs.twimg.com/media/EXZ1t2EXgAELrdO?format=jpg&name=large)](https://twitter.com/CatrionaSwanson/status/1258322956595453952)

<tweet url="https://twitter.com/CatrionaSwanson/status/1258322956595453952" />
