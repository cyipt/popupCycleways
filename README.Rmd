...
- Cycling potential: only roads with high cycling potential, of 100 or more in the long-term Go Dutch scenario, were selected
...
The results below show all roads with a 'spare lane' in the low average traffic conditions created by the partial lockdown (light blue) plus the top 10 roads of a minimum length in terms of estimated cycling potential under the Government Target scenario in the PCT.  
