...
Datasets from the PCT and CyIPT project were merged, resulting key variables summarised in Table 1.
A map showing the spatial distribution of hospitals in the case study city of Leeds, which is used for demonstrating the methods, is shown in Figure \@ref(fig:hospitals).
...
m1 = tm_shape(r_main %>% mutate(`Highway type` = highway2)) +
