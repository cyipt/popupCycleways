...
2. Measures to close roads entirely to particular classes of vehicle, including time-limited closures, as in New York's 'Open Streets' scheme [@litman_pandemicresilient_2020].
...
```{r t1, results='asis', fig.cap="Summary of the road segment dataset for Leeds."}
...
The results of the method applied to the city of Leeds are shown in Figure \@ref(fig:res) (see [cyipt.bike/rapid](https://www.cyipt.bike/rapid/west-yorkshire/) for interactive version) and Table 1.
